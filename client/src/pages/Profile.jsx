...
import { updateUserStart, updateUserSuccess, updateUserFailure, signOutUserStart } from '../redux/userSlice';
import { useDispatch } from 'react-redux';
import { deleteUserFailure, deleteUserSuccess, deleteUserStart } from '../redux/userSlice';
import { sign } from 'jsonwebtoken';
import { signOut } from 'firebase/auth';
import { signOutUserSuccess, signOutUserFailure } from '../redux/userSlice';
...
return (
  ...
  {fileUploadError ? (
    ...
    ""
        ...
        <input type="text" placeholder="username" defaultValue= {currentUser.usernam} id="username" className="border p-3 rounded-lg"  onChange={handleChange}/>
